                    ...
                    <div className="row">
                        ...
                        <div className="content col-md-6 col-sm-12">
                            <form onSubmit={this.handleSubmit} style={{overflow: 'hidden'}}>
                                <input className="texto" type="text" id="titleReport" placeholder="Titulo de mi reporte" onChange={this.handleChange} />
                                ...
                                <input type="text" id="author" placeholder="Tu nombre" onChange={this.handleChange}/>
